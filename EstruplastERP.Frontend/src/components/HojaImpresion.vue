...
<template>
    <div id="hoja-de-impresion" class="hoja-papel">
        ...
        >
                        ...
                        <tbody>
                            <tr v-for="(r, i) in receta" :key="i">
                                ...
                                <td style="text-align:center">
                                    <div v-if="r.esEstearato"><span style="font-weight:bold; font-size: 14px;">{{ r.cantidad }} %</span></div>
                                    <div v-else>
                                        <input 
                                            type="number" 
            ...
            <div v-if="cantidadCopias === 2 && n === 1" class="linea-corte">
...
.mitad-hoja .producto-nombre { font-size: 16px; }
