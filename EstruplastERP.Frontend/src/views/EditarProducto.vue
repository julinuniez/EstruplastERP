...
const eliminarProducto = async () => {
    ...
    try {
        const response = await api.delete(`/Productos/eliminar/${producto.value.id}`);
        Alertas.exito(response.data.mensaje || "Producto eliminado");
        router.push('/productos'); 
    } catch (e) {
        console.error(e);
        Alertas.error("❌ Error al eliminar el producto.");
    } finally {
                ...
                <div class="grid-3">
                    ...
                    <div class="campo">
                        ...
                        <div class="input-stock-wrapper">
                            <input type="number" v-model.number="producto.stockActual" disabled class="input-readonly font-bold" step="0.01">
                        </div>
                    </div>
                    ...
                    <div class="campo mt-2">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" v-model.number="producto.precioCosto" step="0.01" class="input-money" :class="{'input-error': faltaPrecioCosto}">
                        </div>
                    ...
                    <div v-if="producto.esProductoTerminado" class="campo mt-2">
...
.input-stock { border: 2px solid #3498db !important; background-color: #f0f8ff; font-weight: bold; color: #2c3e50; width: 100%; box-sizing: border-box; }
