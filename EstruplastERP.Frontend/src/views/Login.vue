...
if (urlBase === '/api' && window.location.port === '5173') {
    console.warn("⚠️ Detectado entorno DEV con ruta relativa. Forzando proxy interno /api");
    urlBase = '/api'; // Aprovechamos el proxy que configuraste en vite.config.ts
}
...
async function ingresar() {
    ...
    try {
        ...
        // Llamamos a la acción del Store nuevo
